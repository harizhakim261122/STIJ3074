...
<div class="header">
  <a href="homepageLogin.php" class="logo">UUM Lost and Found System</a>
...
if (isset($_COOKIE["timer"])){
  if (isset($_GET['operation'])) {
    ...
    try {
      $sql = "DELETE FROM missing_items WHERE title='$title' AND IDnumber='$IDnumber'";
      $conn->exec($sql);
...
try {
    ...
    echo "<p><h1 align='center'>Lost & Found Items</h1></p>";
        ...
        foreach($missing_items as $missing_items) {
            ...
            echo "<td><a href='homepageLogin.php?IDnumber=".$missing_items['IDnumber']."&operation=del' onclick= 'return confirm(\"Are you sure to delete data?\");'>Delete</a><br>
            <a href='update.php'>Update</a></td>";
            echo "</tr>";
            echo "<tr>";
        }
        echo "</table>";
        echo "<p align='center'><a href='addItems.html'>Insert lost items</a></p>";
