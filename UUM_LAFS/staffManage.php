                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo"> <a href="staffManage.php"><img src="images/logo.png" alt="#"></a> </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="limit-box">
                                <nav class="main-menu">
                                    <ul class="menu-area-main">
                                        <li class="active"> <a href="lodgeReportStaff.html">Report Lost Item</a> </li>
                                        <li> <a href="report.php">Reported Items</a> </li>
                                        <li> <a href="addlostitems.html">Add Lost Item</a> </li>
                                        <li> <a href="staffMainpage.php">Logout</a> </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
...
try {
    ...
    echo "<p><h1 align='center'>LOST AND FOUND ITEM</h1></p>";
        ...
        foreach($missing_items as $missing_items) {
            ...
            echo "<td><a href='update.html'>Update</a><br>
            <a href='archieve.php'>Archieve</a></td>";
            echo "</tr>";
            echo "<tr>";
        }
        echo "</table>";
